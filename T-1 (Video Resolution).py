...
if __name__ == "__main__":
    commands = {
        ...
        6: 't svc atn buttons ok',
        7: 't svc atn buttons down',
        8: 't svc atn buttons ok',
        9: 't svc atn buttons ok',
        10: 't svc atn buttons up',
        11: 't svc atn buttons up',
    ...
    expected_responses = {
        ...
        8: ["---- Apply resolution with ID: 4 ----"],
        9: ["one = 1 two = 0"],
        10: ["RECEIVE INTERNAL SYS MENU TASK = 2"],
        11: ["RECEIVE INTERNAL SYS MENU TASK = 2"],
        12: ["---- Apply resolution with ID: 2 ----"],
        13: ["SCALES TASK RESUMED"]
    }
