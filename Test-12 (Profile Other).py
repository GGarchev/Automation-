...
if __name__ == "__main__":
    commands = {
        ...
        14: 't svc atn buttons down',
        15: 't svc atn buttons ok',
        16: 't svc atn buttons down',
        17: 't svc atn buttons down',
        18: 't svc atn buttons ok',
        19: 't svc atn buttons down',
        20: 't svc atn buttons ok',
        21: 't svc atn buttons func1',
    ...
    expected_responses = {
        ...
        10: "RECEIVE INTERNAL SYS MENU TASK = 12",
        11: "one = 1 two = 0",
        12: "COPY SWITCH",
        13: ["RECEIVE INTERNAL SYS MENU TASK = 51", "RECEIVE INTERNAL SYS MENU TASK = 58"],
        14: "RECEIVE INTERNAL SYS MENU TASK = 4",
        15: "one = 1 two = 0",
        16: "COPY SWITCH",
        17: "DELETE SWITCH",
        18: ["RECEIVE INTERNAL SYS MENU TASK = 51", "RECEIVE INTERNAL SYS MENU TASK = 58"],
        19: "RECEIVE INTERNAL SYS MENU TASK = 4",
        20: "RECEIVE INTERNAL SYS MENU TASK = 12",
        21: "RECEIVE INTERNAL SYS MENU TASK = 13",
        22: "SCALES TASK RESUMED"
    }


    # Call the function and pass both `commands` and `expected_responses`
    log_uart_data(port="COM4", baudrate=115200, log_dir=log_dir, commands=commands, expected_responses=expected_responses)